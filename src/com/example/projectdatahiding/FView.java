...
public class FView extends Activity {
	 ...
	 ImageButton fexit1;
	 ImageButton fshare1;
	public static String fnewPath2=null;
	//public static String newPath3="NEWPATH3";
	
	private Bundle extrasf3 = null;
	
	public static ImageView fnewImage;
	 ...
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        extrasf3 = getIntent().getExtras();
	        
		       fnewPath2     = extrasf3.getString(FImageProcess.fnewPath);
		       
		    
		       Log.d("newP",""+fnewPath2);
		     ...
		     /*  try {
		       ...
		       */
		       ...
		       File fimgFile = new  File(fnewPath2);
